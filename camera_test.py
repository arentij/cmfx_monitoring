...
cap = cv2.VideoCapture("/dev/video0") # cam 2 is video2 cam1 is video4
...
# plt.imshow(frame)
# print(frame)
cv2.imwrite('static/camphoto_temp0.jpg', frame)
os.replace("static/camphoto_temp0.jpg", "static/camphoto0.jpg")
